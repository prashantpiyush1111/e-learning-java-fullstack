...
public interface CourseRepository extends JpaRepository<Course, Long> {
    ...
    Page<Course> findByStatusAndCategoryIgnoreCase(Course.CourseStatus status, String category, Pageable pageable);
    Page<Course> findByStatusAndTitleContainingIgnoreCase(Course.CourseStatus status, String title, Pageable pageable);
    Page<Course> findByStatusAndCategoryIgnoreCaseAndTitleContainingIgnoreCase(Course.CourseStatus status, String category, String title, Pageable pageable);
    List<Course> findByInstructorIdOrderByCreatedAtDesc(Long instructorId);
    List<Course> findByStatusOrderByCreatedAtAsc(Course.CourseStatus status);
